...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="login.jsp">登录</a>&nbsp; <a href="result.jsp" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
                ...
                <ul class="cate_list">
                	...
                	<li>
                        ...
                        <div class="carbg">
                            ...
                            <a href="addCar.do?id=<%=product.getId()%>" class="j_car">加入购物车</a>
                        </div>
                    </li>
                    <%
                        }
